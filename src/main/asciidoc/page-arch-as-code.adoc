...
## 4. Проектирование enterprise-приложений

image::images/hexagon.png[Контекст, 500]

### 4.1. Основные составляющие архитектуры

#### 4.1.1. Презентация данных
...
----
Сначала разработать программное обеспечение, а после документацию.

* Готовый софт частично сам себя опишет.
----

#### 4.2.1. Выгрузить DDL для описания таблиц БД
...
#### 4.2.2. Приложить screenshot схемы базы данных

image::images/database-screenshot.png[Схема БД, 500]

#### 4.2.3. Приложить ссылку на OpenAPI развернутого сервиса
